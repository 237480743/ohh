!function(){
    function o(w,v,i){
        ...
        function l(){
            ...
            return{
                l:w,z:o(v,"zIndex",999),o:o(v,"opacity",0.9),c:o(v,"color","150,150,150"),n:o(v,"count",150)
            }
        }
        function k(){
            ...
            t.forEach(function(i){
                ...
                w.splice(w.indexOf(i),1)
                    ...
                    var u=document.createElement("canvas"),s=l(),c="c_n"+s.l,e=u.getContext("2d"),r,n,m=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(i){
                        window.setTimeout(i,1000/500)
                    },a=Math.random,f={x:null,y:null,max:2000};
                    u.id=c;
                    u.style.cssText="position:fixed;top:0;pointer-events:none;left:0;z-index:"+s.z+";opacity:"+s.o;j("body")[0].appendChild(u);
                    k(),window.onresize=k;
                    window.onmousemove=function(i){
                        ...
                        for(var t=[],p=0;s.n>p;p++){
                            ...
                            t.push({x:h,y:g,xa:q,ya:d,max:10000
                            })
                        }
                        setTimeout(function(){
                            b()
